  ...
  return (
    <div className="w-full bg-zinc-900 py-2 fixed top-0 left-0 z-50">
      <nav className="bg-zinc-800 flex justify-between items-center mx-[10%] py-5 rounded-2xl relative">
        ...
        <div className="logo mx-8 hidden md:block">
          <FontAwesomeIcon icon={faComment} className='text-white text-2xl' />
        </div>

        {/* Desktop Menu */}
        <div className="hidden md:flex space-x-4 ibm-plex-mono-regular">
        ...
        <div className="logo mr-8 hidden md:flex items-center gap-4">
